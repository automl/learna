...
from utils.configs_to_validation import _validate_config, _fill_config, _write_config, modes, timeouts


def generate_execution_script(config_id, config, job_id, output_dir, mode, restore_path=None):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--restore_path", default=None, type=Path, help="The path to load model from")
    ...
    generate_execution_script(config_id, config, args.job_id, args.output_dir.resolve(), args.mode, args.restore_path)
